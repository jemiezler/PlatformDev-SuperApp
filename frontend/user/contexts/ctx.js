...
var useStorageState_1 = require("@/hooks/useStorageState");
var api_1 = require("@/utils/api/api");
var apiServiceTypes_1 = require("@/utils/api/apiServiceTypes");
...
function useSession() {
    var value = (0, react_1.useContext)(AuthContext);
...
function SessionProvider(_a) {
    ...
    var _b = (0, useStorageState_1.useStorageState)("session"), _c = _b[0], isLoading = _c[0], session = _c[1], setSession = _b[1];
    var logIn = function (email, password) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, api_1.$API)(apiServiceTypes_1.ApiService.AUTH, "/login", "POST", { email: email, password: password })];
                case 1:
                    response = _a.sent();
