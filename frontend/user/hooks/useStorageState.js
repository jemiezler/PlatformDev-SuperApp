...
exports.setStorageItemAsync = setStorageItemAsync;
exports.useStorageState = useStorageState;
var react_1 = require("react");
var SecureStore = __importStar(require("expo-secure-store"));
var react_native_1 = require("react-native");
function useAsyncState(initialValue) {
    if (initialValue === void 0) { initialValue = [true, null]; }
    return (0, react_1.useReducer)(function (state, action) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, SecureStore.setItemAsync(key, value)];
                case 4:
                    _a.sent();
                    _a.label = 5;
...
function useStorageState(key) {
    // Public
    var _a = useAsyncState(), state = _a[0], setState = _a[1];
    // Get
