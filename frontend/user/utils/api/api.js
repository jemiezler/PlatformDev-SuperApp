...
function $API(service_1, endpoint_1) {
    return __awaiter(this, arguments, void 0, function (service, endpoint, method, body, headers) {
        var baseUrl, response, error, data, error_1;
        if (method === void 0) { method = 'GET'; }
        if (headers === void 0) { headers = {}; }
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    baseUrl = apiEndpoints_1.default[service] || DEFAULT_URL;
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 6, , 7]);
